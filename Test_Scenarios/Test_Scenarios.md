...
This document contains high-level test scenarios designed for testing the public website of Kapital Bank (for practice purposes only). The goal of this project is to demonstrate manual QA skills including:
